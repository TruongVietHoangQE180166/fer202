...
// Import thêm 8 hình ảnh mới nếu có
...
function FullMenu() {
  ...
  const allPizzas = [
    ...
    { img: menu5, title: "BBQ Chicken Pizza", price: "$21.99", category: "Meat" },
    { img: menu6, title: "Veggie Pizza", price: "$17.99", category: "Vegetarian" },
    { img: menu7, title: "Pepperoni Pizza", price: "$20.99", category: "Meat" },
    { img: menu8, title: "Four Cheese Pizza", price: "$22.99", category: "Vegetarian" },
    // 8 loại pizza mới
    ...
    { img: menu5, title: "White Pizza", price: "$19.99", category: "Vegetarian" },
    { img: menu6, title: "Taco Pizza", price: "$22.99", category: "Meat" },
    { img: menu7, title: "Mediterranean Pizza", price: "$21.99", category: "Vegetarian" },
    { img: menu8, title: "Barbecue Bacon Pizza", price: "$23.99", category: "Meat" },
  ];
